    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[90%] cursor-auto overflow-hidden rounded-3xl bg-white font-inter shadow-2xl sm:w-[520px]">
        ...
        <div className="relative overflow-hidden px-4 pt-4 sm:px-6 sm:pt-6">
          ...
          <h2 className="relative z-10 text-center font-semibold text-[24px] sm:text-[36px]">
            Deposit Successful
          </h2>
        ...
        <div className="p-4 sm:p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg">
                  {formatCurrency(depositedAmount, currency)}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="mt-8 flex justify-center">
              {explorerUrl ? (
                <Link
                  ...
                  className="mb-4 flex items-center justify-center gap-2 font-medium text-[#6562FD] hover:underline"
                >
          ...
          <Button
            onClick={() => onOpenChange(false)}
            className="flex w-full items-center justify-center gap-x-3 rounded-xl bg-[var(--color-primary)] py-4 font-inter font-semibold text-base text-white transition-opacity hover:opacity-90"
          >
            <span>Done</span>
